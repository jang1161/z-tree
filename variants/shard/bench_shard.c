/*
 * bench_shard.c  –  Benchmark for sharded ZTree (13 independent trees,
 *                    shared zone pool).
 *
...
static void run_test(const char *dev_path, int num_threads)
{
    ...
    printf("\n===== Running with %d threads (sharded ×%d) =====\n",
           num_threads, ZTREE_NUM_SHARDS);
...
int main(int argc, char *argv[])
{
    ...
    printf("Random key set generated (%d keys, sharded ×%d).\n",
           total_keys, ZTREE_NUM_SHARDS);
